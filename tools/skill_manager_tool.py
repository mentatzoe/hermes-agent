...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "Create when you discover a workflow worth reusing, overcome a tricky failure, "
        "learn a reusable correction from the user, or the user asks you to remember "
        "a procedure. Update an existing skill when it already covers the lesson.\n"
        "When use reveals stale instructions, missing steps, or pitfalls, verify "
        "the correction and update the skill before finishing.\n"
